<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
	...
	pageEncoding="UTF-8"%>
            ...
            <div class="row">
                <div class="col-md-4">
                    <button type="button" class="btn btn-outline-info" data-toggle="modal" data-target="#MayModal" id="addMayBtn">Add</button>
                </div>
            </div>
            <p></p>
            <div class="row">
                        ...
                        <tbody>
                            <c:forEach items="${dsMay }" var="item">
                                <tr>
                                    ...
                                    <td><button type="button" class="btn btn-outline-info editMayBtn" data-toggle="modal" data-target="#MayModal" id="editMayBtn">Edit</button>
                                        <button type="button" class="btn btn-outline-info" data-toggle="" data-target="" id="deleteBtn">Delete</button>
                                        <button type="button" class="btn btn-outline-info dangKyMBtn" data-toggle="modal" data-target="#suDungMayModal" id="dangKyMBtn">Đăng
								Kí Sử Dụng Máy</button></td>
                                </tr>
                            </c:forEach>
                        </tbody>
                    </table>
